...
function ReservationForm({cabin, user}) {
 ...
 //const createBookingWithData = createBooking.bind(null,bookingData);
  ...
  {range.from && range.to && (
  <p>
    {range.from.toDateString()} until {range.to.toDateString()}
  </p>
)}
      ...
      className='bg-primary-900 py-10 px-16 text-lg flex gap-5 flex-col'>
        <div className='space-y-2'>
          ...
          >
            ...
            <div className='space-y-2'>
  <label htmlFor='hasBreakfast' className='flex items-center gap-3'>
    <input
      type='checkbox'
      name='hasBreakfast'
      id='hasBreakfast'
    ...
    <span>Include breakfast?</span>
        ...
        <div className='flex justify-end items-center gap-6'>
          {!(startDate && endDate) ? (<p className='text-primary-300 text-base'>Start by selecting dates</p>
            ...
            <LoadingButton pendingLabel='Reserving in progress...'>Reserve now</LoadingButton>)}
